 ...
 * @author luis
 */
public class Ventana_Causas_Primarias extends javax.swing.JFrame {
    Archivo manejo_archivo=new Archivo();
    String lectura;
    
    public Ventana_Causas_Primarias() {
        initComponents();
        setTitle("CAUSAS PRIMARIAS");
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            manejo_archivo.insertar_registro("causas primarias");
            lectura = manejo_archivo.consulta_bloque("causas primarias");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_Causas_Primarias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_Causas_Primarias().setVisible(true);
            }
        });
    }
