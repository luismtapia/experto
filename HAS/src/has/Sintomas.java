...
public class Sintomas {
    ...
    public void insertar() throws FileNotFoundException, IOException {
        ...
        RandomAccessFile archivo=new RandomAccessFile("sintomas", "rw");
        ...
        do {            
            ...
            System.out.println("otro sintoma? : si= 1, NO=0");
            n=entrada.nextInt();
        } while (n==1);
        archivo.close();
    }
    ...
    public void leer_sintomas() throws FileNotFoundException, IOException{
        ...
        RandomAccessFile leer_archivo= new RandomAccessFile("sintomas", "r");
