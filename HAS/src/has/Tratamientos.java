...
public class Tratamientos {
 ...
 int llave,n;
    ...
    public void insertar() throws FileNotFoundException, IOException {
        ...
        RandomAccessFile archivo=new RandomAccessFile("Tratamiento", "rw");
        ...
        do {            
            ...
            System.out.println("Desea ingresar otro tratamiento? : si= 1, NO=0");
            n=entrada.nextInt();
        } while (n==1);
        archivo.close();
    }
    ...
    public void leer_sintomas() throws FileNotFoundException, IOException{
        ...
        RandomAccessFile leer_archivo= new RandomAccessFile("Tratamiento", "r");
