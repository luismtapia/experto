...
public class CausasSecundarias {
    ...
    public void leer_sintomas() throws FileNotFoundException, IOException{
        ...
        RandomAccessFile leer_archivo= new RandomAccessFile("CausasSecundarias", "r");
